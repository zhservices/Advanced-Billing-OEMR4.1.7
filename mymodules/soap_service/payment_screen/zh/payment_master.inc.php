...
<table width="958" border="0" cellspacing="0" cellpadding="10" bgcolor="#DEDEDE"><tr><td>
	<table width="938" border="0" style="border:1px solid black" cellspacing="0" cellpadding="0">
	  <tr height="5">
	  ...
	  <tr>
		...
		<td align="left" class="text" ><input type='text' size='9' name='check_date' id='check_date' class="class1 text "  value="<?php echo $screen=='new_payment'?htmlspecialchars(oeFormatShortDate(date('Y-m-d'))):htmlspecialchars(oeFormatShortDate($CheckDate));?>"/></td>
	   ...
	   <script>
	    ...
	    <td align="left" class="text">
	      <input type='text' size='9' name='post_to_date' id='post_to_date' class="class1 text "   value="<?php echo $screen=='new_payment'?htmlspecialchars(oeFormatShortDate(date('Y-m-d'))):htmlspecialchars(oeFormatShortDate($PostToDate));?>"  readonly="" onchange="populateFields()"/>
	      <input type="hidden" name="prevPTD" id="prevPTD" value="<?php echo $screen=='new_payment'?htmlspecialchars(oeFormatShortDate(date('Y-m-d'))):htmlspecialchars(oeFormatShortDate($PostToDate));?>">
	    </td>
	    <td><img src='../../interface/main/calendar/modules/PostCalendar/pntemplates/default/images/new.jpg' align='absbottom'
	   ...
	   <script>
		...
		?>
		<input type="text" name="check_number"  style="width:140px;<?php echo $CheckDisplay;?>"  autocomplete="off"  value="<?php echo htmlspecialchars($CheckNumber);?>"  onKeyUp="ConvertToUpperCase(this)"  id="check_number"  class="text "   onblur="check_number_verify(this.value)"/>
	  ...
	  <tr class="text" id="capdatetd" <?php echo $dispcapdatetd;?>>
		...
		<td align="left" class="text" colspan="3"><?php echo billing_facility('billing_facility',$CapbillfacId,'class1');?></td>
	  ...
	  <tr>
		...
		<td align="left"><input type='text' size='9' name='deposit_date' id='deposit_date'  onKeyDown="PreventIt(event)"   class="class1 text " value="<?php echo $screen=='new_payment'?htmlspecialchars(oeFormatShortDate(date('Y-m-d'))):htmlspecialchars(oeFormatShortDate($DepositDate));?>"    />	   </td>
		<td><img src='../../interface/main/calendar/modules/PostCalendar/pntemplates/default/images/new.jpg' align='absbottom'
	...
	?>
	  <tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="280">
		  ...
		  <tr>
			<td width="100"><a href="#" onClick="javascript:return SavePayment();" class="css_button" style="width:85px"><span><?php echo htmlspecialchars( xl('Save Changes'), ENT_QUOTES);?></span></a></td>
		    <td width="110"><a href="#" onClick="javascript:ResetForm()" class="css_button" style="width:95px"><span><?php echo htmlspecialchars( xl('Cancel Changes'), ENT_QUOTES);?></span></a></td>
		    <td width="70" id="allocate"><a href="#" class="css_button" onClick="javascript:OpenEOBEntry();"><span><?php echo htmlspecialchars( xl('Allocate'), ENT_QUOTES);?></span></a></td>
		  </tr>
		</table>		</td>
	  </tr>
	<?php
