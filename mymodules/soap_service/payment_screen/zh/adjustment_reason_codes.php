...
$adjustment_reasons = array(
 ...
 //Additional denial codes listed in Payments screen(Must not contain Underscores(_))
	'ADD INFO/ DOC PR'  =>  'Claim lacks info/ required additional documents/ required info not provided',
	'ADD INFO/ DOC PT'  =>  'Ptient have not sent required additional documents/ required info not provided',
	'AUTH'  =>  'Claim Denied for no Authorization/ missing Auth/ invalid Auth',
	'COB'  =>  'Claim Denied for COB',
	'DND DUP'  =>  'Duplicate claim service/ previously paid/ denied as duplicate',
	'GLOBAL'  =>  'Claim Denied for Inclusive/ Bundled/ Exclusive/ post-operative/ pre-operative',
	'INC PD'  =>  'Claim paid to incorrect address/provider',
	'INV COD'  =>  'Claim Denied for Invalid/ Missing/ Incorrect CPT/ICD/Modifier/POS',
	'INV DOS'  =>  'Dos is after DOD / DOS and DOB in not maching',
	'INV PAYER'  =>  'Denied as work related injury/ covered by another payer/ Invalid payer',
	'INV PT INFO'  =>  'Claim denied as patient cannot be identified/ invalid Pt name/ invalid id',
	'MED NESS'  =>  'Charges exceed fee schedule/ medically not necessary/ pre-existing condition',
	'MED REC'  =>  'Need additional Documents/Need for Med. Necssty',
	'NON CVRD'  =>  'CPT/ procedure is not covered under pt plan/ no covereage for newborns/ depednt cov',
	'PAYER REFND'  =>  'Due to over payment/ not our patient/ paid in error/ paid more then allowed amt',
	'PD MAX'  =>  'Claim Denied as Primary paid more then the allowed amt',
	'PR ELIG'  =>  'Provider not eligible/ non-billable/ non covered per Provider Contract',
	'PRI EOB'  =>  'Claim Denied for Primary EOB',
	'PRO ADJ'  =>  'Balance needs to be written off/ Provider adjustment/ Recoupment/ Capitation',
	'PROV#'  =>  'Claim Denied for Missing/Invalid Provider#',
	'PT ELIG'  =>  'Patient not eligible/max benefits/ non covered/ Policy termed',
	'PTRESP'  =>  'Patient Responsibility/ Co-insurance/ Deductible/ Co-payment/Paid to pt',
	'REFF'  =>  'No Referral on file/ absence/ exceeded referral',
	'REVIEW/ IN PROCESS'  =>  'Insurance acknowledgment letter',
	'TFL'  =>  'Denied for Untimely Filing',
