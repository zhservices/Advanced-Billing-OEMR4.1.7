		...
		<td colspan="14" align="left" >
			<table width="936" border="0" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
			  ...
			  <tr>
				...
				<td width="261"><input type="hidden" id="hidden_ajax_patient_close_value" value="<?php echo $Message=='' ? htmlspecialchars($NameNew) : '' ;?>" />
				...
				<td width="41" colspan="2" style="padding-left:5px;" ><div  class="text" name="patient_name" id="patient_name"  
				...
				<td width="83" class="text">&nbsp;<input type="radio" name="RadioPaid" onClick="SearchOnceMore()" <?php echo $_REQUEST['RadioPaid']=='Non_Paid' 
				|| $_REQUEST['RadioPaid']=='' ? 'checked' : '' ; ?>  value="Non_Paid" id="Non_Paid"  /><?php echo htmlspecialchars( xl('Non Paid'), ENT_QUOTES) ?></td>
				<td width="164" class="text"><input type="radio" name="RadioPaid" onClick="SearchOnceMore()" 
				...
				<td width="154" class="text"><input type="radio" name="RadioPaid" onClick="SearchOnceMore()" 
				...
				<td class="text" width="165">&nbsp;<?php echo htmlspecialchars(xl_list_label('Insurance Adjudicated Date'),ENT_QUOTES);?></td>
				<td class="text" width="95">
				 <input type="text" name="ins_adjud_date" id="ins_adjud_date" size="7" value="<?php echo $_REQUEST['ins_adjud_date'];?>"/>
				 ...
				 <script>
				      Calendar.setup({inputField:"ins_adjud_date", ifFormat:"<?php echo $DateFormat; ?>", button:"img_post_to_date"});
				 </script>
				</td>
			  </tr>
			  <tr>
			  ...
			  <tr class="text" bgcolor="#dddddd">
				...
				?>
				 <table border="0" cellpadding="0" cellspacing="0" align="center">
				  ...
				  <tr class="text">
				   <td class="right" width="40"><?php echo htmlspecialchars( xl('Amnt.'), ENT_QUOTES) ?></td>
				   <td class="right" width="42"><?php echo htmlspecialchars( xl('GRP'), ENT_QUOTES) ?></td>
				   <td width="30"><?php echo htmlspecialchars( xl('RSN'), ENT_QUOTES) ?></td>
				  </tr>
				 </table>
				<?php
				}
			  ...
			  <tr class="text"  bgcolor='<?php echo $bgcolor; ?>' id="trCharges<?php echo $CountIndex; ?>">
				...
				?>
				 <table border="0" cellpadding="0" cellspacing="0" align="center" id="AdjustmentTable<?php echo $CountIndex;?>">
				  <tr class="text">
				   <td>
				    <input  name="AdjAmount<?php echo $CountIndex; ?>-Sub1"  onKeyDown="PreventIt(event)" 
				    autocomplete="off"  id="AdjAmount<?php echo $CountIndex; ?>-Sub1"  
				    ...
				    type="text"   style="width:40px;text-align:right; font-size:12px" />
				   </td>
				   <td class="left right">
				    <?php echo generate_select_list("AdjGRP".$CountIndex."-Sub1", "payment_group_codes", "", "Adjustment Group Code",'','','','',array('style'=>'width:42px;font-size:12px'));?>
				   </td>
				   <td>
				    <input  name="AdjRSN<?php echo $CountIndex; ?>-Sub1"  id="AdjRSN<?php echo $CountIndex; ?>-Sub1"  
				    type="text"   style="width:30px;text-align:right; font-size:12px" />
				   </td>
				  </tr>
				 </table>
				<?php
				...
				?>
				  ...
				  onChange="ValidateNumeric(this);ScreenAdjustment(this,<?php echo $CountIndex; ?>);UpdateTotalValues(<?php echo $CountIndexAbove*1+1; ?>,<?php echo $TotalRows; ?>,'AdjAmount','initialAdjAmounttotal');RestoreValues(<?php echo $CountIndex; ?>)"  
				  type="text"   style="width:112px;text-align:right; font-size:12px" />
				<?php
				}
				?>
				<input type="hidden" name="subcount<?php echo $CountIndex; ?>" id="subcount<?php echo $CountIndex; ?>" value="1" />
				</td>
				<td class="<?php echo $StringClass; ?>" >
				<?php
				if($GLOBALS['msp_capturing_payment_screen']){
				?>
				 <table border="0" cellpadding="0" cellspacing="0" align="center" id="DeductibleTable<?php echo $CountIndex;?>">
				  <tr class="text">
				   <td>
				    <input  name="Deductible<?php echo $CountIndex; ?>-Sub1"  id="Deductible<?php echo $CountIndex; ?>-Sub1" 
				    ...
				    style="width:40px;text-align:right; font-size:12px" />
				   </td>
				   <td class="left right">
				    <?php echo generate_select_list("DedGRP".$CountIndex."-Sub1", "payment_group_codes", "", "Deductible Group Code",'','','','',array('style'=>'width:42px;font-size:12px'));?>
				   </td>
				   <td>
				    <input  name="DedRSN<?php echo $CountIndex; ?>-Sub1"  id="DedRSN<?php echo $CountIndex; ?>-Sub1"  
				    type="text"   style="width:30px;text-align:right; font-size:12px" />
				   </td>
				  </tr>
				 </table>
				...
				?>
				  <input  name="Deductible<?php echo $CountIndex; ?>-Sub1"  id="Deductible<?php echo $CountIndex; ?>-Sub1" 
				  onKeyDown="PreventIt(event)"  onChange="ValidateNumeric(this);UpdateTotalValues(<?php echo $CountIndexAbove*1+1; ?>,<?php echo $TotalRows; ?>,'Deductible','initialdeductibletotal');"   autocomplete="off"   type="text"   
				  style="width:112px;text-align:right; font-size:12px" />
				<?php
				}
				?>
				</td>
