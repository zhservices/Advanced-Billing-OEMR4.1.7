...
class X12Partner extends ORDataObject{
  ...
  function get_idqual_array() {
	...
	function get_x12_username(){
		return $this->x12_username;
	}
	function set_x12_username($s){
		$this->x12_username=$s;
	}

	function get_x12_password(){
		return $this->x12_password;
	}
	function set_x12_password($p){
		$this->x12_password=$p;
	}
