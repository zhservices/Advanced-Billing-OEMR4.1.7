...
$GLOBALS_METADATA = array(
  ...
  'Connectors' => array(
	...
	'external_module_username' => array(
      xl('External Module Username'),
      'text',                           // data type
      '',
      xl('External Module Username(Put Blank If no External Modules).')
    ),

    'external_module_password' => array(
      xl('External Module Password'),
      'pwd',                           // data type
      '',
      xl('External Module Password(Put Blank If no External Modules).')
    ),
    
    'external_module_path' => array(
